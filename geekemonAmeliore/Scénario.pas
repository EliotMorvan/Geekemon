...
//type ganondorf est propre au combat du tutoriel
type Ganondorf = record
  ATQ : integer;
  PV : integer;
end;

//type JonSnow est propre au combat du tutoriel
type JonSnow = record
  ATQ : integer;
  PV : integer;
end;
...
///////////////////////////
procedure scenarIntroduction1 (var nom1 : string);
//La première partie de l'introduction, qui appelle la fonction choixNom.
 begin
    effacerEcran;
...
//////////////////////////////
procedure tutoriel();
//le tutoriel s'arrete lorsque les PV de ganondorf atteingent 0.
...
var
  ...
  Ganon : Ganondorf;
  Jon : JonSnow;
  //les booléens ci dessous permettent l'affichage d'un texte spécial n'aparaissant
  //qu'une seule fois
...
effacerEcran;
  ...
  if premiereAttaque = false then            //l'option "utiliser une potion" apparait lorsque
  writeln ('3 - Utiliser une potion');       //l'utilisateur a déja attaqué au moins une fois.
  ...
  effacerEcran;
    ...
    1 : begin
      ...
      //Si les PV de ganon ne permettent pas d'entrer dans la boucle alors il est KO et le combat s'arrête.
      fin := true;
    end;
    2 :
    begin
...
/////////////////////////////
procedure quete(var geekedex : arrayOfGeekemon; var geekEquipe : arrayOfEquipe; var nbPotion : integer; var DressEquipe : arrayOfEquipeDresseur; nom1 : string ; avancement : avancementQuete; nomdresseurs : arrayofdresseurs; equipeStockage : arrayofPc; quitter : integer);
//Dès que la partie d'une quête, le booléen correspondant à cette partie prend la valeur true,
//ce qui permet de continuer le scénario quand on souhaite reprendre la quête.
//La quête consiste surtout en du texte et des combats de boss.
var
  numéroBoss : integer;
...
function readVerif(min : integer; max : integer) : integer;
//Cette fonction a pour but de redemander à l'utilisateur de saisir une valeur
//si il entre une valeur ne correspondant pas aux choix proposés
//dans un menu.
var
  res : integer;
begin
  readln(res);
  while (res<min) or (res>max) do //valeurs minimales et maximales pour le choix
  begin
