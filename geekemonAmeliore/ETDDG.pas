unit ETDDG;
//Cette unité contient les sous-programmes relatifs aux actions effectuées à l'ETTDG.
interface
uses Geekemon;
...
////////////////////////////////
procedure soin (var geekedex : arrayOfGeekemon; var geekEquipe : arrayOfEquipe; var nbPotion : integer; var DressEquipe : arrayOfEquipeDresseur);
//Tous les geekemons de l'équipe reprennent leurs PVs de base stockés dans le champ PVdeBase
begin
  ...
  writeln ('Félicitations ! Vos geekemons sont en pleine forme.');
end;
//////////////////////////////
...
while (sortie = 2) do
  begin
    ...
    writeln ('Bonjour, bienvenue sur le PC de JIMMY, ici vous pouvez stocker jusqu''à quatre geekemons ou vous pouvez aussi les récuperer');
    writeln ('Que voulez-vous faire?');
    writeln ('1. Stocker ses Geekemons');
    writeln ('2. Récuperer ses geekemons');
    ...
    //Selon la valeur de ChoixStockage, la case à l'indice
    //du pc prend les données de la case de l'équipe au même
    ...
    1 : Begin
          ...
          //On efface les données de la case 0 de geekEquipe à l'aide de
          ...
          writeln ('Votre geekemon a bien été stocké sur le PC de JIMMY!');
          writeln('Vous pouvez aussi chosir de récuperer un geekemon : ');
          writeln('1 Continuer à stocker');
          writeln('2. Récuperer un geekemon');
          readln(choix);
    ...
    4 : Begin
        ...
        writeln('Vous pouvez aussi choisir de récuperer vos geekemons');
        begin
          writeln('Vous avez au moins un geekemon de stocké, vous pouvez donc en retirer au moins un');
          writeln('Quel geekemon voulez-vous récuperer dans votre équipe :');
          writeln;
          writeln('1. Récuperer : ',EquipeStockage[0].nom);
          writeln('2. Récuperer : ',EquipeStockage[1].nom);
          writeln('3. Récuperer : ',EquipeStockage[2].nom);
          writeln('4. Récuperer : ',EquipeStockage[3].nom);
          readln(choixrecup);
          if choixrecup=1 then
            begin
              writeln(' A quel emplacement voulez vous récuperer ',EquipeStockage[0].nom,'?');
              writeln;
              writeln('1. A l''emplacement de votre premier geekemon');
              writeln('2. A l''emplacement de votre second geekemon');
              writeln('3. A l''emplacement de votre troisième geekemon');
              writeln('4. A l''emplacement de votre dernier geekemon');

            readln(choixespace);
            case choixespace of
            //Selon le geekemon que l'on souhaite récupérer et l'emplacement
           ...
           1 : begin
              ...
              writeln(geekequipe[0].nom,' fait désormais partie de votre équipe !');
              end;
        ...
        2 : begin
              ...
              writeln(geekequipe[1].nom,' fait désormais partie de votre équipe !');
            end;
        ...
        3 : begin
              ...
              writeln(geekequipe[2].nom,' fait désormais partie de votre équipe !');
            end;
        4 : begin
              writeln('Salut ',EquipeStockage[0].nom,'!');
              ...
              writeln(geekequipe[3].nom,' fait désormais partie de votre équipe !');
             end;
             end;
            end;
          if choixrecup=2 then
         begin
          writeln(' A quel emplacement voulez vous récuperer ',EquipeStockage[1].nom,'?');
          writeln;
          writeln('1. A l''emplacement de votre premier geekemon');
          writeln('2. A l''emplacement de votre second geekemon');
          writeln('3. A l''emplacement de votre troisième geekemon');
       ...
       case choixespace of
        ...
        4 : begin
             ...
             if choixrecup=3 then
                begin
                  writeln(' A quel emplacement voulez vous récuperer ',EquipeStockage[2].nom,'?');
                  writeln;
                  writeln('1. A l''emplacement de votre premier geekemon');
                  writeln('2. A l''emplacement de votre second geekemon');
                  writeln('3. A l''emplacement de votre troisième geekemon');
        ...
        4 : begin
             ...
             if choixrecup=4  then
                begin
                  writeln(' A quel emplacement voulez vous récuperer ',EquipeStockage[3].nom,'?');
                  writeln;
                  writeln('1. A l''emplacement de votre premier geekemon');
                  writeln('2. A l''emplacement de votre second geekemon');
                  writeln('3. A l''emplacement de votre troisième geekemon');
